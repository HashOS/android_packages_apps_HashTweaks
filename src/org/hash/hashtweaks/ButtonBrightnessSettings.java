...
public class ButtonBrightnessSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int ButtonBrightness = Settings.System.getInt(getContentResolver(),
                Settings.System.HASH_CUSTOM_BUTTON_BRIGHTNESS, 255);
        mManualButtonBrightness.setValue(ButtonBrightness / 1);
        ...
        final int currentBrightness = Settings.System.getInt(resolver,
                Settings.System.HASH_CUSTOM_BUTTON_BRIGHTNESS, customButtonBrightness);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mButtonTimoutBar) {
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.HASH_CUSTOM_BUTTON_BRIGHTNESS, value * 1);
        } else {
            return false;
        }
        return true;
